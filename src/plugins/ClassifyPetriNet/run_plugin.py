"""
This script is called by the plugin-wrapper, ClassifyPetriNet.js, which passes down the
...
from ClassifyPetriNet import ClassifyPetriNet
...
plugin = ClassifyPetriNet(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
